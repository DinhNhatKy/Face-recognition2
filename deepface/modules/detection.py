...
def extract_faces(
    ...
    if img is None:
        raise ValueError(f"Exception while loading")
    ...
    for face_obj in face_objs:
        ...
        if grayscale is True:
            print("Parameter grayscale is deprecated. Use color_face instead.")
...
def detect_faces(
    ...
    if expand_percentage < 0:
        ...
        print( f"Expand percentage cannot be negative but you set it to {expand_percentage}.", "Overwritten it to 0.")
...
if __name__ == "__main__":
    ...
    print(result[0]['is_real'])
    print(result[0]['antispoof_score'])
